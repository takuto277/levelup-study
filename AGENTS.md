...
| Mobile (KMP Android) | `cd apps/mobile && ./gradlew :shared:compileDebugKotlinAndroid :composeApp:compileDebugKotlinAndroid` | CI と同等 |
...
| `github-pr-review` | PR レビュー（`@codex #123 のPRレビューして` 形式の依頼、指摘あり/再チェック待ち/OK の PRレビュー状態ラベル更新に対応） |
